...
var prison = {
	...
	text4: "You look around a bit more, waiting for said Guard. Suddenly you notice a small and blunt Butter Knife. You hear something that sounds like it could be a strong Footstep, but it might just be a Stone. <br><br> <button onclick=\"pickUpKnife();\" class=\"use\">Fast! Pick up the Knife before someone sees it!</button>",
	...
	text9: "You look left. There is a Door, and you can see something glowing through underneath it. On your right, you just see the corridor and a Wall. It may be a dead End.",
	...
	text16: "After some time which felt like ages you finally got through the rope. What now? <br><br> <button onclick=\"checkOutLock();\" class=\"look\">Check out the Lock</button>",
	...
	//Buttons:
	button1: "<button onclick=\"Water();\" class=\"think\">Concentrate on the Water</button>",
	button2: "<button onclick=\"thinkFurther();\" class=\"think\">Think more about Stuff</button>",
	button3: "<button onclick=\"deathEnding1();\" class=\"ending\">End this Path</button>",
	button4: "<button onclick=\"wait();\" class=\"time\">Wait</button>",
	button5: "<button onclick=\"cutRope();\" class=\"use\">Let's try cutting the Rope! Maybe its just sharp enoguh!</button> <br><br> <button onclick=\"hideKnife();\" class=\"use\">Hide the Knife</button>",
	button6: "<button onclick=\"lookThrough();\" class=\"look\">Spy through the \'Window\'</button> <br><br> <button onclick=\"shout();\" class=\"use\">Shout to try and get its Attention</button>",
	button7: "<button onclick=\"spy();\" class=\"look\">Spy around the Corner to see who or what opened the Cell</button> <br><br> <button onclick=\"lookDownCorridors();\" class=\"look\">Look down the Corridors</button>",
	...
	button16: "<button onclick=\"lookForExit();\" class=\"look\">Look for a Way out</button>",
	button17: "<button onclick=\"cutBarWithKnife();\" class=\"use\">Try cutting the Bar with the Knife</button> <br><br> <button onclick=\"hitBar();\" class=\"look\">Hit the Bar until it Breaks</button> <br><br> <button onclick=\"analyzeBar();\" class=\"look\">Analyze the Bar</button>",
	...
	button21: "<button onclick=\"knifeLockPick();\" class=\"go\">Try to open it with the Knife</button>",
	button22: "<button onclick=\"lookDownCorridors();\" class=\"look\">Look down the Corridors closely</button>",
	button23: "<button onclick=\"inspectLock();\" class=\"look\">Inspect the Lock</button>",
	...
	weird2: "ARE YOU SURE YOU WANT TO LEAVE THE KNIFE? ITS SUCH A MAGNIFICENT KNIFE ISNT IT? <button onclick=\"pickUpKnife();\" class=\"use\">Pick up the Knife</button> <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> <button onclick=\"leaveKnife2();\" class=\"secret2\">No</button>",
